...
android {
 ...
 defaultConfig { applicationId="uk.co.ukmla.gputester"; minSdk=28; targetSdk=35; versionCode=1; versionName="0.1.0"; testInstrumentationRunner="androidx.test.runner.AndroidJUnitRunner" }
