...
if(!serviceWorker.includes('ukmla-cards-v5-question-bank')||!serviceWorker.includes("url.origin!==self.location.origin"))throw new Error('Offline service worker safeguards are missing.');
